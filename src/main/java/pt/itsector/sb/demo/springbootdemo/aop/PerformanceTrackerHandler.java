package pt.itsector.sb.demo.springbootdemo.aop;
...
public class PerformanceTrackerHandler implements ObservationHandler<Observation.Context> {
    ...
    public void onStart(Observation.Context context) {
        ...
        context.put("perfInitTimeTracker",System.currentTimeMillis());
    }
    ...
    public void onStop(Observation.Context context) {
        long initialTime = context.getOrDefault("perfInitTimeTracker",0L);
        log.info("Execution stopped {} duration {} ms", context.getName(), (System.currentTimeMillis() - initialTime));
